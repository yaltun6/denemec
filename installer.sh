#!/usr/bin/bash
#
#           CasaOS Installer Script v0.4.8#
...
readonly CASA_UNINSTALL_URL="https://get.casaos.io/uninstall/v0.4.8"
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-AppManagement/releases/download/v0.4.8/linux-${TARGET_ARCH}-casaos-app-management-v0.4.8.tar.gz"
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS/releases/download/v0.4.8/linux-${TARGET_ARCH}-casaos-v0.4.8.tar.gz"
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-UI/releases/download/v0.4.8/linux-all-casaos-v0.4.8.tar.gz"
